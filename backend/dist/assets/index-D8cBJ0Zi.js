 ...
 */ (function (e) {
  ...
  function C(x, T) {
    ...
    try {
      for (
        p(T), f = n(s);
        f !== null && (!(f.expirationTime > T) || (x && !Te()));

      ) {
        var Q = f.callback;
        if (typeof Q == "function") {
          (f.callback = null), (m = f.priorityLevel);
          var q = Q(f.expirationTime <= T);
          (T = e.unstable_now()),
      ...
      if (f !== null) var pr = !0;
        ...
        var Ct = n(a);
        Ct !== null && Bl(w, Ct.startTime - T), (pr = !1);
      }
      return pr;
    } finally {
      (f = null), (m = O), (k = !1);
...
function fa() {
  if (bt) {
    var e = bt,
      t = en;
    if (((en = bt = null), Ru(e), t)) for (e = 0; e < t.length; e++) Ru(t[e]);
  }
}
function da(e, t) {
  return e(t);
...
function Et() {
  if (!oo && Ke !== null) {
    ...
    try {
      ...
      throw (Ke !== null && (Ke = Ke.slice(e + 1)), ga(Ri, Et), l);
    } finally {
      (A = t), (oo = !1);
    }
  }
...
function tc(e) {
  ...
  function m(d, c, p, w) {
    ...
    if (typeof p == "object" && p !== null) {
      ...
      if (Tn(p) || wn(p)) return C !== null ? null : h(d, c, p, w, null);
      Nr(d, p);
    }
    return null;
  }
  function k(d, c, p, w, C) {
    ...
    if (typeof w == "object" && w !== null) {
      ...
      if (Tn(w) || wn(w)) return (d = d.get(p) || null), h(c, d, w, C, null);
      Nr(c, w);
    }
    return null;
  }
...
function Cp(e, t, n, r, l, o, i) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = co(Error(S(422)))), Rr(e, t, i, r))
      : t.memoizedState !== null
  ...
  if (l.data === "$!") {
    ...
    return (r = u), (o = Error(S(419))), (r = co(o, r, void 0)), Rr(e, t, i, r);
  }
  if (((u = (i & e.childLanes) !== 0), de || u)) {
    ...
    return ou(), (r = co(Error(S(421)))), Rr(e, t, i, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
  ...
  switch ((Ii(t), t.tag)) {
    ...
    case 6:
      if (e && t.stateNode != null) Fc(e, t, e.memoizedProps, r);
        ...
        if (((n = Tt(er.current)), Tt(Ve.current), Pr(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[Be] = t),
...
function Dc(e) {
  ...
  t !== null && ((e.alternate = null), Dc(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Be], delete t[Zn], delete t[Qo], delete t[cp], delete t[fp])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Ti(t, n | 1), me(t, K()), !(D & 6) && ((fn = K() + 500), Et()));
      }
      break;
    case 13:
      jt(function () {
...
const ih = (e, t, n, { allOwnKeys: r } = {}) => (
  ...
  Rs = "0123456789",
  lf = { DIGIT: Rs, ALPHA: mo, ALPHA_DIGIT: mo + mo.toUpperCase() + Rs },
...
function Ml(e, t, n) {
  ...
  function h(y, v, R) {
    ...
    return pi(y) ? !0 : (t.append(Ts(R, v, o), a(y)), !1);
  }
  const f = [],
    m = Object.assign(Th, {
      defaultVisitor: h,
...
const Yh = $e.hasStandardBrowserEnv
  ? {
      write(e, t, n, r, l, o) {
...
const Zh = $e.hasStandardBrowserEnv
  ? (function () {
...
function am() {
  ...
  return (
    ...
    Ie.jsxs(Ie.Fragment, {
      children: [
        Ie.jsx("h1", { children: "Anime Record App" }),
        Ie.jsxs("p", { children: ["Record : ", e.length] }),
        e.map((n) =>
          Ie.jsxs(
            "div",
            {
              children: [
                Ie.jsx("p", { children: n.mc }),
                Ie.jsx("p", { children: n.discraption }),
                Ie.jsx("p", { children: n.release_year }),
              ],
            },
            n.name
          )
...
wo.createRoot(document.getElementById("root")).render(
  Ie.jsx(jf.StrictMode, { children: Ie.jsx(am, {}) })
);
